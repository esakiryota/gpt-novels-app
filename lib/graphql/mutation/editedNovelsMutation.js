...
mutation ($content: String!, $category_pk: Int!, $editor_comment: String!, $original_pk: Int!, $title: String!, $user_id: String!, $user_pk: Int!, $edited_percent: float8!) {
    insert_edited_novels_one(object: {content: $content, category_pk: $category_pk, editor_comment: $editor_comment, original_pk: $original_pk, title: $title, user_id: $user_id, user_pk: $user_pk, edited_percent: $edited_percent}) {
      content
      category_pk
      created_at
      editor_comment
